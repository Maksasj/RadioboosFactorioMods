...
data:extend({
	{	type = "technology",
		name = "kelp_farm",
		icon = "__Aquatic_Industries__/graphics/entity/kelp_farm/kelp_farm.png",
		icon_size = 200,
		effects =
		{
		  {
	...
	},
	{
		...
		minable = {hardness = 0.2, mining_time = 0.5, result = "kelp_farm"},
		max_health = 900,
		corpse = "big-remnants",
		...
		animation =
		{
			...
			{
				{
					filename = "__Aquatic_Industries__/graphics/entity/kelp_farm/kelp_farm_animation.png",
					priority = "high",
					width = 160,
					height = 200,
					frame_count = 18,
		...
		crafting_categories = {"ai-kelp-farm"},
		crafting_speed = 4,
		energy_source =
		{
		  type = "electric",
