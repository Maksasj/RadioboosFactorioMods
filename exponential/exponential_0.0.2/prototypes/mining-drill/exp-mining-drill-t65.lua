...
--exp-mining-drill-t65.lua
local btint = {r=0.69,g=0.67,b=0.92};

-- Electrified Stone Furnace
exp_tmp_drill = util.table.deepcopy(data.raw["mining-drill"]["electric-mining-drill"]);
exp_tmp_drill.name = "exp-mining-drill-t65";
exp_tmp_drill.minable = {mining_time = 0.3, result = "exp-mining-drill-t65"};
...
exp_tmp_drill.mining_speed = 33.0;
exp_tmp_drill.module_specification.module_slots = 9
exp_tmp_drill.energy_usage = " 3015kW";
...
data:extend({
	{
	type = "item",
	name = "exp-mining-drill-t65",
	icon = "__exponential__/graphics/icons/mining-drill/exp-mining-drill-t65.png",
	icon_size = 64, icon_mipmaps = 4,
	subgroup = "extraction-machine",
	order = "a[items]-c[advanced-mining-drill]",
	place_result = "exp-mining-drill-t65",
	stack_size = 50
	}
})
...
data:extend({
	...
	enabled = false,
	energy_required = 2,
	ingredients = {{'exp-mining-drill-t64', 2}},
	result = "exp-mining-drill-t65"
	}
})
...
data:extend({
	...
	icon = "__exponential__/graphics/icons/mining-drill/exp-mining-drill-t65.png",
	icon_size = 64, icon_mipmaps = 4,
	prerequisites = {'exp-mining-drill-t64'},
	unit = {
		count = 100,
		ingredients = {
