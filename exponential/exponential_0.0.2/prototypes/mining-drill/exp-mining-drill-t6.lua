...
--exp-mining-drill-t6.lua
local btint = {r=0.54,g=0.22,b=0.79};

-- Electrified Stone Furnace
exp_tmp_drill = util.table.deepcopy(data.raw["mining-drill"]["electric-mining-drill"]);
exp_tmp_drill.name = "exp-mining-drill-t6";
exp_tmp_drill.minable = {mining_time = 0.3, result = "exp-mining-drill-t6"};
...
exp_tmp_drill.mining_speed = 3.5;
exp_tmp_drill.module_specification.module_slots = 3
exp_tmp_drill.energy_usage = " 360kW";
...
data:extend({
	{
	type = "item",
	name = "exp-mining-drill-t6",
	icon = "__exponential__/graphics/icons/mining-drill/exp-mining-drill-t6.png",
	icon_size = 64, icon_mipmaps = 4,
	subgroup = "extraction-machine",
	order = "a[items]-c[advanced-mining-drill]",
	place_result = "exp-mining-drill-t6",
	stack_size = 50
	}
})
...
data:extend({
	...
	enabled = false,
	energy_required = 2,
	ingredients = {{'exp-mining-drill-t5', 2}},
	result = "exp-mining-drill-t6"
	}
})
...
data:extend({
	...
	icon = "__exponential__/graphics/icons/mining-drill/exp-mining-drill-t6.png",
	icon_size = 64, icon_mipmaps = 4,
	prerequisites = {'exp-mining-drill-t5'},
	unit = {
		count = 100,
		ingredients = {
