...
--exp-mining-drill-t11.lua
local btint = {r=0.35,g=0.25,b=0.64};

-- Electrified Stone Furnace
exp_tmp_drill = util.table.deepcopy(data.raw["mining-drill"]["electric-mining-drill"]);
exp_tmp_drill.name = "exp-mining-drill-t11";
exp_tmp_drill.minable = {mining_time = 0.3, result = "exp-mining-drill-t11"};
...
exp_tmp_drill.mining_speed = 6.0;
exp_tmp_drill.module_specification.module_slots = 4
exp_tmp_drill.energy_usage = " 585kW";
...
data:extend({
	{
	type = "item",
	name = "exp-mining-drill-t11",
	icon = "__exponential__/graphics/icons/mining-drill/exp-mining-drill-t11.png",
	icon_size = 64, icon_mipmaps = 4,
	subgroup = "extraction-machine",
	order = "a[items]-c[advanced-mining-drill]",
	place_result = "exp-mining-drill-t11",
	stack_size = 50
	}
})
...
data:extend({
	...
	enabled = false,
	energy_required = 2,
	ingredients = {{'exp-mining-drill-t10', 2}},
	result = "exp-mining-drill-t11"
	}
})
...
data:extend({
	...
	icon = "__exponential__/graphics/icons/mining-drill/exp-mining-drill-t11.png",
	icon_size = 64, icon_mipmaps = 4,
	prerequisites = {'exp-mining-drill-t10'},
	unit = {
		count = 100,
		ingredients = {
