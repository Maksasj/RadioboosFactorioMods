...
--exp-mining-drill-t69.lua
local btint = {r=0.38,g=0.22,b=0.63};

-- Electrified Stone Furnace
exp_tmp_drill = util.table.deepcopy(data.raw["mining-drill"]["electric-mining-drill"]);
exp_tmp_drill.name = "exp-mining-drill-t69";
exp_tmp_drill.minable = {mining_time = 0.3, result = "exp-mining-drill-t69"};
...
exp_tmp_drill.mining_speed = 35.0;
exp_tmp_drill.module_specification.module_slots = 9
exp_tmp_drill.energy_usage = " 3195kW";
...
data:extend({
	{
	type = "item",
	name = "exp-mining-drill-t69",
	icon = "__exponential__/graphics/icons/mining-drill/exp-mining-drill-t69.png",
	icon_size = 64, icon_mipmaps = 4,
	subgroup = "extraction-machine",
	order = "a[items]-c[advanced-mining-drill]",
	place_result = "exp-mining-drill-t69",
	stack_size = 50
	}
})
...
data:extend({
	...
	enabled = false,
	energy_required = 2,
	ingredients = {{'exp-mining-drill-t68', 2}},
	result = "exp-mining-drill-t69"
	}
})
...
data:extend({
	...
	icon = "__exponential__/graphics/icons/mining-drill/exp-mining-drill-t69.png",
	icon_size = 64, icon_mipmaps = 4,
	prerequisites = {'exp-mining-drill-t68'},
	unit = {
		count = 100,
		ingredients = {
