...
exp_tmp_drill.name = "exp-mining-drill-t1";
exp_tmp_drill.minable = {mining_time = 0.3, result = "exp-mining-drill-t1"};
...
exp_tmp_drill.mining_speed = 1.0;
exp_tmp_drill.module_specification.module_slots = 3
exp_tmp_drill.energy_usage = " 135kW";
...
data:extend({
	{
	type = "item",
	name = "exp-mining-drill-t1",
	icon = "__exponential__/graphics/icons/mining-drill/exp-mining-drill-t1.png",
	icon_size = 64, icon_mipmaps = 4,
	subgroup = "extraction-machine",
	order = "a[items]-c[advanced-mining-drill]",
	place_result = "exp-mining-drill-t1",
	stack_size = 50
	}
})
...
data:extend({
	...
	enabled = false,
	energy_required = 2,
	ingredients = {{'electric-mining-drill', 2}},
	result = "exp-mining-drill-t1"
	}
})
