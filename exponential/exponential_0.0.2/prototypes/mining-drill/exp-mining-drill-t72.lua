...
exp_tmp_drill.name = "exp-mining-drill-t72";
exp_tmp_drill.minable = {mining_time = 0.3, result = "exp-mining-drill-t72"};
...
exp_tmp_drill.mining_speed = 36.5;
exp_tmp_drill.module_specification.module_slots = 10
exp_tmp_drill.energy_usage = " 3330kW";
...
data:extend({
	{
	type = "item",
	name = "exp-mining-drill-t72",
	icon = "__exponential__/graphics/icons/mining-drill/exp-mining-drill-t72.png",
	icon_size = 64, icon_mipmaps = 4,
	subgroup = "extraction-machine",
	order = "a[items]-c[advanced-mining-drill]",
	place_result = "exp-mining-drill-t72",
	stack_size = 50
	}
})
...
data:extend({
	...
	enabled = false,
	energy_required = 2,
	ingredients = {{'exp-mining-drill-t71', 2}},
	result = "exp-mining-drill-t72"
	}
})
...
data:extend({
	...
	icon = "__exponential__/graphics/icons/mining-drill/exp-mining-drill-t72.png",
	icon_size = 64, icon_mipmaps = 4,
	prerequisites = {'exp-mining-drill-t71'},
	unit = {
		count = 100,
		ingredients = {
