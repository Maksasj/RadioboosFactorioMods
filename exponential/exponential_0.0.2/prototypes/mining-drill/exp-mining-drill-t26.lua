...
exp_tmp_drill.name = "exp-mining-drill-t26";
exp_tmp_drill.minable = {mining_time = 0.3, result = "exp-mining-drill-t26"};
...
exp_tmp_drill.mining_speed = 13.5;
exp_tmp_drill.module_specification.module_slots = 5
exp_tmp_drill.energy_usage = " 1260kW";
...
data:extend({
	{
	type = "item",
	name = "exp-mining-drill-t26",
	icon = "__exponential__/graphics/icons/mining-drill/exp-mining-drill-t26.png",
	icon_size = 64, icon_mipmaps = 4,
	subgroup = "extraction-machine",
	order = "a[items]-c[advanced-mining-drill]",
	place_result = "exp-mining-drill-t26",
	stack_size = 50
	}
})
...
data:extend({
	...
	enabled = false,
	energy_required = 2,
	ingredients = {{'exp-mining-drill-t25', 2}},
	result = "exp-mining-drill-t26"
	}
})
...
data:extend({
	...
	icon = "__exponential__/graphics/icons/mining-drill/exp-mining-drill-t26.png",
	icon_size = 64, icon_mipmaps = 4,
	prerequisites = {'exp-mining-drill-t25'},
	unit = {
		count = 100,
		ingredients = {
