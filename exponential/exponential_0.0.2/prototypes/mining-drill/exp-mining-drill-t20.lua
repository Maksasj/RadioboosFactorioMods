...
--exp-mining-drill-t20.lua
local btint = {r=0.49,g=0.72,b=0.34};

-- Electrified Stone Furnace
exp_tmp_drill = util.table.deepcopy(data.raw["mining-drill"]["electric-mining-drill"]);
exp_tmp_drill.name = "exp-mining-drill-t20";
exp_tmp_drill.minable = {mining_time = 0.3, result = "exp-mining-drill-t20"};
...
exp_tmp_drill.mining_speed = 10.5;
exp_tmp_drill.module_specification.module_slots = 5
exp_tmp_drill.energy_usage = " 990kW";
...
data:extend({
	{
	type = "item",
	name = "exp-mining-drill-t20",
	icon = "__exponential__/graphics/icons/mining-drill/exp-mining-drill-t20.png",
	icon_size = 64, icon_mipmaps = 4,
	subgroup = "extraction-machine",
	order = "a[items]-c[advanced-mining-drill]",
	place_result = "exp-mining-drill-t20",
	stack_size = 50
	}
})
...
data:extend({
	...
	enabled = false,
	energy_required = 2,
	ingredients = {{'exp-mining-drill-t19', 2}},
	result = "exp-mining-drill-t20"
	}
})
...
data:extend({
	...
	icon = "__exponential__/graphics/icons/mining-drill/exp-mining-drill-t20.png",
	icon_size = 64, icon_mipmaps = 4,
	prerequisites = {'exp-mining-drill-t19'},
	unit = {
		count = 100,
		ingredients = {
