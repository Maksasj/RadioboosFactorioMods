...
exp_tmp_drill.name = "exp-mining-drill-t32";
exp_tmp_drill.minable = {mining_time = 0.3, result = "exp-mining-drill-t32"};
...
exp_tmp_drill.mining_speed = 16.5;
exp_tmp_drill.module_specification.module_slots = 6
exp_tmp_drill.energy_usage = " 1530kW";
...
data:extend({
	{
	type = "item",
	name = "exp-mining-drill-t32",
	icon = "__exponential__/graphics/icons/mining-drill/exp-mining-drill-t32.png",
	icon_size = 64, icon_mipmaps = 4,
	subgroup = "extraction-machine",
	order = "a[items]-c[advanced-mining-drill]",
	place_result = "exp-mining-drill-t32",
	stack_size = 50
	}
})
...
data:extend({
	...
	enabled = false,
	energy_required = 2,
	ingredients = {{'exp-mining-drill-t31', 2}},
	result = "exp-mining-drill-t32"
	}
})
...
data:extend({
	...
	icon = "__exponential__/graphics/icons/mining-drill/exp-mining-drill-t32.png",
	icon_size = 64, icon_mipmaps = 4,
	prerequisites = {'exp-mining-drill-t31'},
	unit = {
		count = 100,
		ingredients = {
